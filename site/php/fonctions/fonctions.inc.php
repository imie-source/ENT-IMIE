...
/**
	*Fonction renvoieUneListe prend pour argument un tableau généré par la base de donnée
	...
	*@param string $urlQuery Chaîne de caractères qui est une url avec le début
	*						d'une query string
	*@return string Liste en HTML de type ul avec des liens gros et centrés,
	*				nécessite knacss
*/
